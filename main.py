...
class popupWindow(object):
    ...
    def __init__(self, master):
        ...
        self.e.pack(pady=7)
        self.b = Button(top, text='Let me in!', command=self.cleanup, font=('Courier', 14))
        self.b.pack()
...
entity_label = Label(window, text='Add account', font=('Courier', 18))
